    ...
    <Row>
      ...
      >
        ...
        <p>
          ...
          related to it, still belong to Scholarship Hall Alumni.
        </p>
        <p>
          Scholarship Hall Alumni is committed to ensuring that the app is as useful and efficient
          as possible. For that reason, we reserve the right to make changes to the app or to charge
        ...
        <p>
          ...
          order to provide my Service. It’s your responsibility to keep your phone and access to the
          ...
          mean that the Resident 51 app won’t work properly or at all.
        </p>
        <p>
        ...
        <p>
          ...
          out of battery and you can’t turn it on to avail the Service, Scholarship Hall Alumni
        ...
        <p>
          ...
          information to us so that we can make it available to you. Scholarship Hall Alumni accepts
          no liability for any loss, direct or indirect, you experience as a result of relying
        ...
        <p>
          ...
          if you want to keep using the app. Scholarship Hall Alumni does not promise that it will
          ...
          you in these terms will end; (b) you must stop using the app, and (if needed) delete it
          from your device.
        </p>
